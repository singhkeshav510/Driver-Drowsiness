...
int serial;
char array1[]="     keshav      ";                //the string to print on the LCD
char array2[]="  hello boss!                       ";                  //the string to print on the LCD
char array3[]="   hi  bhai         ";                //the string to print on the LCD
